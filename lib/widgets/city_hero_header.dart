      ...
      child: Stack(
        ...
        children: [
          Image.asset(
            ...
            errorBuilder: (_, __, ___) => const ColoredBox(color: AppColors.heroNavy),
          ),
          ...
          SafeArea(
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  Expanded(child: _Headline(greeting: t('heroGreeting'), prefix: t('heroHeadlinePrefix'), city: city)),
                  if (trailing != null) ...[
...
class _Headline extends StatelessWidget {
  const _Headline({required this.greeting, required this.prefix, required this.city});
      ...
      children: [
        ...
        Text.rich(
          ...
          style: theme.textTheme.headlineSmall?.copyWith(
            ...
            fontWeight: FontWeight.w600,
            height: 1.3,
            shadows: const [Shadow(color: Color(0x40000000), blurRadius: 16, offset: Offset(0, 2))],
          ),
        ),
      ],
    );
