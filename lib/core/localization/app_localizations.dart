...
class AppLocalizations {
  ...
  static const _strings = <String, Map<AppLanguage, String>>{
    ...
    'heroGreeting': {
      AppLanguage.ary: 'سلام ومرحبا بيك',
      AppLanguage.ar: 'سلام وأهلا بك',
      AppLanguage.de: 'Salam und herzlich willkommen',
      AppLanguage.fr: 'Salam et bienvenue',
      AppLanguage.en: 'Salam and welcome',
    },
    'heroHeadlinePrefix': {
      AppLanguage.ary: 'لقا الرحلة الجاية ديالك ل',
      AppLanguage.ar: 'ابحث عن رحلتك القادمة إلى',
      AppLanguage.de: 'Finde deinen nächsten Flug nach',
      AppLanguage.fr: 'Trouve ton prochain vol vers',
      AppLanguage.en: 'Find your next flight to',
    },
    'heroDefaultDestination': {
    ...
    'popularDestinations': {
      AppLanguage.ary: 'وجهات مطلوبة فالمغرب',
      AppLanguage.ar: 'وجهات شائعة في المغرب',
      AppLanguage.de: 'Beliebte Ziele in Marokko',
      AppLanguage.fr: 'Destinations populaires au Maroc',
      AppLanguage.en: 'Popular destinations in Morocco',
    },
    'trustBestPriceTitle': {
      AppLanguage.ary: 'أرخص ثمن',
      AppLanguage.ar: 'أفضل سعر',
      AppLanguage.de: 'Bestpreise',
      AppLanguage.fr: 'Meilleurs prix',
      AppLanguage.en: 'Best prices',
    },
    'trustBestPriceSubtitle': {
      AppLanguage.ary: 'كنقلبو على الأرخص',
      AppLanguage.ar: 'نبحث عن الأرخص',
      AppLanguage.de: 'Auch schlaue Umwege',
      AppLanguage.fr: 'Même les détours malins',
      AppLanguage.en: 'Clever detours too',
    },
    'trustDirectTitle': {
      AppLanguage.ary: 'ديريكت للشركة',
      AppLanguage.ar: 'مباشرة لشركة الطيران',
      AppLanguage.de: 'Direkt zur Airline',
      AppLanguage.fr: 'Direct vers la compagnie',
      AppLanguage.en: 'Straight to the airline',
    },
    'trustDirectSubtitle': {
      AppLanguage.ary: 'كنحجزو والو عندنا',
      AppLanguage.ar: 'لا نحجز نحن',
      AppLanguage.de: 'Wir buchen nicht selbst',
      AppLanguage.fr: 'Nous ne réservons pas',
      AppLanguage.en: 'We never book for you',
    },
    'trustDarijaTitle': {
      AppLanguage.ary: 'بالدارجة',
      AppLanguage.ar: 'بالدارجة',
      AppLanguage.de: 'Auf Darija',
      AppLanguage.fr: 'En darija',
      AppLanguage.en: 'In Darija',
    },
    'trustDarijaSubtitle': {
      AppLanguage.ary: 'هضر معانا بلغتك',
      AppLanguage.ar: 'تحدث بلغتك',
      AppLanguage.de: 'Sprich, wie du sprichst',
      AppLanguage.fr: 'Parle comme tu parles',
      AppLanguage.en: 'Speak as you speak',
    },
    'outboundFlight': {
